...
public class TokenUtil {
	 ...
	 * 生成令牌
	 *
	 * @param tokenStyleEnum 令牌风格枚举
	 * @return String
	 * @author yang.lu
	 */
	public static String generateToken(TokenStyleEnum tokenStyleEnum) {
		String prefix;
		int totalLength = switch (tokenStyleEnum) {
			case ACCESS_TOKEN -> {
				prefix = "AT_";
			...
			default -> throw new IllegalArgumentException("不支持的令牌类型: " + tokenStyleEnum.name());
		};
