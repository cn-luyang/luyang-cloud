...
import io.github.luyang.platform.uaa.auth.strategy.grant.handler.AuthorizationCodeHandler;
...
public class OAuth2GrantContext {
	...
	static {
		GRANT_POOL.put(OAuth2GrantType.AUTHORIZATION_CODE, SpringUtil.getBean(AuthorizationCodeHandler.class));
	}
